...
import com.elysiasilly.fne.common.block.*;
...
public class FEBlocks {
    ...
    // black
    public static final DeferredBlock<Block> BLACK_CINDER
            = regWithItem("black_smooth_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> CUT_BLACK_CINDER
            = regWithItem("black_poured_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> BLACK_CINDER_BLOCK
            = regWithItem("black_cinder_block", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));

    // gray
    public static final DeferredBlock<Block> GRAY_CINDER
            = regWithItem("gray_smooth_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> CUT_GRAY_CINDER
            = regWithItem("gray_poured_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> GRAY_CINDER_BLOCK
            = regWithItem("gray_cinder_block", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));

    // white
    public static final DeferredBlock<Block> WHITE_CINDER
            = regWithItem("white_smooth_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> CUT_WHITE_CINDER
            = regWithItem("white_poured_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> WHITE_CINDER_BLOCK
            = regWithItem("white_cinder_block", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));

    // weathered
    public static final DeferredBlock<Block> WEATHERED_CINDER
            = regWithItem("weathered_smooth_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> CUT_WEATHERED_CINDER
            = regWithItem("weathered_poured_cinder", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
    public static final DeferredBlock<Block> WEATHERED_CINDER_BLOCK
            = regWithItem("weathered_cinder_block", () -> new Block(getProp(Blocks.BLACK_CONCRETE)));
