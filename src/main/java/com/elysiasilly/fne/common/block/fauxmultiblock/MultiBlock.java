package com.elysiasilly.fne.common.block.fauxmultiblock;

import com.elysiasilly.fne.common.block.interfaces.BlockPosRepresentable;
...
public class MultiBlock<T extends Enum<T> & BlockPosRepresentable & StringRepresentable> {
    ...
    private final FauxMultiBlock block;

    public MultiBlock(Class<T> multi, FauxMultiBlock block) {
        this.multi = multi;
        this.block = block;
    }
